    ...
    @includeIf('layouts.partials.header')
        ...
        @includeIf('layouts.partials.sidebar')
            ...
            @includeIf('layouts.partials.footer')
                ...
                <script
                    src="{{ asset('/AdminLTE/plugins/jqvmap/maps/jquery.vmap.usa.js') }}">
                </script>
                <!-- jQuery Knob Chart -->
                ...
                <script
                    src="{{ asset('/AdminLTE/plugins/daterangepicker/daterangepicker.js') }}">
                </script>
                <!-- Tempusdominus Bootstrap 4 -->
                <script
                ...
                <!-- Summernote -->
                <script
                    src="{{ asset('/AdminLTE/plugins/summernote/summernote-bs4.min.js') }}">
                </script>
                <!-- overlayScrollbars -->
                <script
